...
const PROFILE_HTML_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <title>View This Watch Collection on tickIQ</title>
    <meta name="description" content="Explore this curated watch collection with real accuracy data from actual wear. See grail pieces, timing measurements, and discover watches you never knew existed.">
    ...
    <meta name="twitter:title" content="View This Watch Collection on tickIQ">
    <meta name="twitter:description" content="Explore this curated collection with real accuracy data. See grail pieces and timing measurements.">
    <meta name="twitter:image" content="https://tickiq.app/assets/images/og-image-profile-landscape.png">
...
<body>
    ...
    <div class="qr-modal" id="qr-modal">
        <div class="qr-modal-content">
            ...
            <div class="qr-modal-title" id="qr-modal-title">Scan to View Collection</div>
            ...
            <div class="qr-modal-subtitle" id="profile-url-display"></div>
        </div>
    </div>
    ...
    <script>
        ...
        (function() {
            ...
            // Check if accessing /profile directly (not via /u/username rewrite)
            if (pathname === '/profile' || pathname === '/profile.html' || pathname === '/profile/') {
            ...
            // Normal profile page logic continues here
        ...
        // Update page with username
        const usernameElement = document.getElementById('profile-username');
        usernameElement.textContent = \`@\${username}'s Watch Collection\`;

        // Update all meta tags for better sharing
        document.title = \`@\${username}'s Watch Collection - tickIQ\`;

        // Update meta description
        const metaDesc = document.querySelector('meta[name="description"]');
        if (metaDesc) {
            metaDesc.setAttribute('content', \`Explore @\${username}'s watch collection with real accuracy data. See their grail pieces, timing measurements, and mechanical insights on tickIQ.\`);
        }

        // Update Open Graph meta tags
        const ogTitle = document.querySelector('meta[property="og:title"]');
        if (ogTitle) {
            ogTitle.setAttribute('content', \`@\${username}'s Watch Collection on tickIQ\`);
        }

        const ogDesc = document.querySelector('meta[property="og:description"]');
        if (ogDesc) {
            ogDesc.setAttribute('content', \`Explore @\${username}'s curated collection with real accuracy data. See grail pieces and timing measurements from actual wear.\`);
        }

        const ogUrl = document.querySelector('meta[property="og:url"]');
        if (ogUrl) {
            ogUrl.setAttribute('content', \`https://tickiq.app/u/\${username}\`);
        }

        // Update Twitter meta tags
        const twitterTitle = document.querySelector('meta[name="twitter:title"]');
        if (twitterTitle) {
            twitterTitle.setAttribute('content', \`@\${username}'s Watch Collection on tickIQ\`);
        }

        const twitterDesc = document.querySelector('meta[name="twitter:description"]');
        if (twitterDesc) {
            twitterDesc.setAttribute('content', \`Explore @\${username}'s watch collection with real accuracy data on tickIQ.\`);
        }

        // Update iOS app link
        const iosUrl = document.querySelector('meta[property="al:ios:url"]');
        if (iosUrl) {
            iosUrl.setAttribute('content', \`tickiq://profile/\${username}\`);
        }
        ...
        const profileUrl = \`https://tickiq.app/u/\${username}\`;
        ...
        if (isDesktop) {
            ...
            document.getElementById('profile-url-display').textContent = profileUrl.replace('https://', '');

            // Update modal title with username
            document.getElementById('qr-modal-title').textContent = \`View @\${username}'s Collection\`;
