...
(function() {
    ...
    function buildAppStoreURL(campaignToken) {
        const baseURL = 'https://apps.apple.com/app/apple-store/id6749871310';
        const params = new URLSearchParams({
            pt: '128058562',      // Provider Token
            ct: campaignToken,     // Campaign Token (dynamic per page)
    ...
    function renderHeader(options = {}) {
        ...
        // Read campaign token from body data attribute, fallback to 'default'
        const campaignToken = document.body.dataset.campaignToken || 'default';
        const appStoreURL = buildAppStoreURL(campaignToken);
                ...
                <div class="header-content">
                    <div class="header-pill">
                        <div class="pill-content">
                            ...
                            <a href="${appStoreURL}" target="_blank" class="get-app-button">
                                ...
                                <div class="qr-popover">
                                    <div class="qr-code">
                                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=${encodeURIComponent(appStoreURL)}" alt="QR Code for tickIQ App">
                                    </div>
